...
$last_block_reward_btc = null; $last_block_reward_usd = null; 
...
try {
    ...
    if (file_exists($networkDbPath)) {
        ...
        $last_block_reward_btc = $network_data['last_block_reward_btc'] ?? null; 
        $last_block_reward_usd = $network_data['last_block_reward_usd'] ?? null; 
    ...
    } else { $network_difficulty = null; $previous_network_difficulty = null; $network_hashrate = null; $last_block_reward_btc = null; $last_block_reward_usd = null; $difficulty_prediction = null; $error = $error ? $error . " Network DB not found." : "Network DB not found."; }

} catch (Exception $e) { 
    $error = "Database Error: " . $e->getMessage(); 
    $pool_data = []; $user_summary = null; $user_workers = null; $last_update = null; $network_difficulty = null; $previous_network_difficulty = null; $network_hashrate = null; $last_block_reward_btc = null; $last_block_reward_usd = null; $difficulty_prediction = null; $network_hashrate_change = null; $user_data_full = null; 
}
...
<body>
    ...
    <div class="container">
        ...
        <?php if (!$btc_address && isset($network_data)): ?>
            ...
            <table><tbody>
                ...
                <tr>
                    <td class="key">Last Block Reward</td> 
                    <td class="font-mono">
                        <?= htmlspecialchars(number_format($last_block_reward_btc, 8)) ?> BTC 
                        <?php if ($last_block_reward_usd !== null): ?>
                            <span style="opacity: 0.7;">($<?= htmlspecialchars(number_format($last_block_reward_usd, 2)) ?>)</span>
                        <?php else: ?>
                            <span style="opacity: 0.5; font-style: italic;">(USD price API offline? 🤷‍♂️)</span> 
                        <?php endif; ?>
                    </td>
                </tr>
                 <?php endif; ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (mainChartCanvas) {
                ...
                // Theme toggle listener already calls chart re-render via themeSwitcher function
            }
        });
    </script>
</body>
